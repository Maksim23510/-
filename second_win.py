...
class TestWin(QWidget):
   ...
   def initUI(self):
       ...
       self.btn_test1 = QPushButton('txt_test1', self)
       self.btn_test2 = QPushButton('txt_test2', self)
       self.btn_test3 = QPushButton('txt_test3', self)
 
 
       self.text_name = QLabel('txt_opt1')
       self.text_age = QLabel('txt_opt2')
       self.text_test1 = QLabel('txt_instruction2')
       self.text_test2 = QLabel('txt_instruction3')
       self.text_test3 = QLabel('txt_instruction4')
